...
800명이 넘는 contributors와 함께, Spark는 빅데이터에서 가장 크고 활동적인 그리고 Scala로 코딩된 오픈소스 프로젝트 입니다. 이 가이드라인은 [Databricks](http://databricks.com/) 엔지니어들과 함께 작업 할 때 참고를 하기 위해 만들어졌고, 우리의 경험을 알려주기 위해 만들어 졌습니다.

코드는 저자에 의해 __한 번 쓰여집니다__. 그러나 여러 엔지니어들에게 __반복적으로 수정되고 읽힙니다__. 많은 버그들은 보통 코드의 변경으로부터 나옵니다. 그래서 우리는 코드의 가독성과 유지 보수성을 향상시키기 위해 우리의 코드를 최적화 해야합니다. 이를 위해서 단순하고 이해하기 쉬운 코드를 작성할 필요가 있습니다.
