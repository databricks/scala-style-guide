...
Scala는 믿을 수 없을 만큼 강력하고 여러가지 패러다임을 적용 가능한 언어입니다. 우리는 아래의 가이드라인을 지키며 여러가지 프로젝트를 빠른 속도로 진행하고 있습니다. 이 가이드라인이 모든 경우에 맞지는 않을 수 있습니다. 팀이나 회사의 요구사항등에 따라서 일부 다르게 적용 해야 할 수도 있습니다.
